...
namespace Annex.Reactive
{
    public static partial class ObservableEx
    {
        ...
        /// <typeparam name="TResource">The type of resource used during the generation of the resulting sequence. Needs to implement <see cref="IDisposable"/>.</typeparam>
        ...
        /// <see href="https://stackoverflow.com/a/49616041/1409101">Adapted from StackOverflow</see>
        [Pure]
        [NotNull]
